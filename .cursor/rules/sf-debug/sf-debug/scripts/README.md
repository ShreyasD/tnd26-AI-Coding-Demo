# sf-debug Validation Scripts

These scripts provide validation for sf-debug files. In Claude Code,
...
- `parse-debug-log.py` - Parse Salesforce debug logs and provide analysis for Claude auto-fix loop.
