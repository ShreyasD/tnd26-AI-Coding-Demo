# sf-soql Validation Scripts

These scripts provide validation for sf-soql files. In Claude Code,
...
- `post-tool-validate.py` - Post-Tool Validation Hook for sf-soql plugin.
