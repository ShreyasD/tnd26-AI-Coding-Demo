# sf-testing Validation Scripts

These scripts provide validation for sf-testing files. In Claude Code,
...
- `parse-test-results.py` - Parse Apex test results and format for Claude auto-fix loop.
